...
@Controller
@RequestMapping(PathConstant.FACULTY_SYLLABUS_PATH)
public class FacultySyllabusController {
    ...
    public String createSyllabus(@ModelAttribute SyllabusModel syllabus) {
        ...
        return "redirect:/" + PathConstant.FACULTY_SYLLABUS_PATH + "/subject/" + syllabus.getSubject().getSubjectid();
