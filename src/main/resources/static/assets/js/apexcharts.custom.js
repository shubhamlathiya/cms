...
var areachart, areaChartOptions = {
    ...
    chart: {
        type: "area", height: 350, background: "transparent", stacked: !0, toolbar: {show: !1}, zoom: {enabled: !1}
    },
    theme: {mode: colors.chartTheme},
    xaxis: {
        type: "datetime",
...
var radialbarWidgetChart, radialbarWidgetOptions = {
    series: [86], chart: {height: 120, type: "radialBar"}, theme: {mode: colors.chartTheme}, plotOptions: {
        radialBar: {
            hollow: {size: "70%"}, track: {background: colors.borderColor}, dataLabels: {
                show: !0, name: {
                    fontSize: "0.875rem",
                    fontWeight: 400,
                    offsetY: -10,
...
var bubblechart, bubbleChartOptions = {
    ...
    xaxis: {
        tickAmount: 12, type: "category", labels: {
            show: !0, trim: !1, minHeight: void 0, maxHeight: 120, style: {colors: colors.mutedColor, cssClass: "small"}
        }, axisBorder: {show: !1}
    },
    yaxis: {
        labels: {
...
var radarchart, radarChartOptions = {
    ...
    legend: {
        fontFamily: base.defaultFontFamily, fontWeight: 400, labels: {colors: colors.mutedColor, useSeriesColors: !1}
    },
...
var radialbarChart, radialbarOptions = {
    series: [70], chart: {height: 200, type: "radialBar"}, plotOptions: {
        radialBar: {
            hollow: {size: "75%"}, track: {background: colors.borderColor}, dataLabels: {
                show: !0, name: {
                    fontSize: "0.875rem",
                    fontWeight: 400,
                    offsetY: -10,
    ...
    }, stroke: {lineCap: "round"}, labels: ["CPU"]
...
var multiRadialbarChart, multiRadialbarOptions = {
    series: [44, 55, 67, 83], chart: {height: 200, type: "radialBar"}, plotOptions: {
        radialBar: {
            track: {background: colors.borderColor}, dataLabels: {
                name: {
                    fontSize: "0.875rem",
                    fontWeight: 400,
                    offsetY: -10,
    ...
    }, stroke: {lineCap: "round"}, labels: ["Apples", "Oranges", "Bananas", "Berries"]
...
var customAngleChart, customAngleOptions = {
    series: [76, 67, 61, 90], chart: {id: "cta", height: 200, type: "radialBar"}, plotOptions: {
        radialBar: {
            offsetY: 0,
            startAngle: 0,
            endAngle: 270,
    ...
    }, fill: {opacity: 1, colors: chartColors}, labels: ["Vimeo", "Messenger", "Facebook", "LinkedIn"], legend: {
...
var gradientRadialChart, gradientRadialOptions = {
    series: [75], chart: {height: 200, type: "radialBar", toolbar: {show: !1}}, plotOptions: {
        radialBar: {
            startAngle: -135, endAngle: 225, hollow: {
                ...
                imageOffsetY: 0,
                position: "front"
            }, track: {background: colors.backgroundColor, strokeWidth: "67%", margin: 0}, dataLabels: {
                show: !0, name: {
                    fontSize: "0.875rem",
                    fontWeight: 400,
                    offsetY: -10,
    ...
    }, stroke: {lineCap: "round"}, labels: ["Percent"]
...
var strokeRadialChart, strokeRadialOptions = {
    series: [67], chart: {height: 185, type: "radialBar", offsetY: -10}, plotOptions: {
        radialBar: {
            startAngle: -135, endAngle: 125, track: {background: colors.borderColor}, dataLabels: {
                name: {
                    fontSize: "12px",
                    color: colors.mutedColor,
                    offsetY: 90,
    ...
    }, stroke: {dashArray: 4, colors: "#fff"}, labels: ["Median Ratio"]
